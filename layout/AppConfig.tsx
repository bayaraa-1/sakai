    ...
    return (
        <>
            ...
            <Sidebar visible={layoutState.configSidebarVisible} onHide={onConfigSidebarHide} position="right" className="layout-config-sidebar w-20rem">
                ...
                <div className="grid">
                    <div className="col-3">
                        <button className="p-link " onClick={() => _changeTheme('lara-light-indigo', 'light')}>
                            <i className="pi pi-sun" style={{ fontSize: '1.8rem' }} />
                        </button>
                    </div>
                    <div className="col-3">
                        <button className="p-link " onClick={() => _changeTheme('lara-dark-indigo', 'dark')}>
                            <i className="pi pi-moon" style={{ fontSize: '1.8rem' }} />
                        </button>
                    </div>
                </div>
            </Sidebar>
